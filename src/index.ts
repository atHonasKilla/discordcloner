...
client.on("ready", async () => {
  ...
  const guild = client.guilds.cache.get('1169774771307823175');
  if (guild) {
    const channel = guild.channels.cache.get('1169774771307823175');
  ...
  const r = new Discord.RichPresence()
    ...
    .setType('PLAYING')
    .setURL('https://discord.gg/YMHMGuAWJK')
    .setName('RottenCult')
    .setState('Running...')
    .setDetails('Best Server')
    .setAssetsLargeImage('https://cdn.discordapp.com/icons/1169774771307823175/a_909a7184e28c3f01adc6ab257b79ffb1.gif?size=2048')
    .setAssetsLargeText('RottenCult')
    .setAssetsSmallImage('https://cdn.discordapp.com/icons/1169774771307823175/a_909a7184e28c3f01adc6ab257b79ffb1.gif')
    .setAssetsSmallText('Join')
    .setStartTimestamp(dateFromTimestamp)
    .addButton('Join', 'https://discord.gg/YMHMGuAWJK');
